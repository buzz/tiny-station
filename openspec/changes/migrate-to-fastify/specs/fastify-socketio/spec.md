...
Define requirements for Socket.io integration with Fastify using `fastify-socket.io` plugin, maintaining existing real-time functionality and authentication.
...
Chat functionality MUST work identically to existing implementation.
...
- fastify-authentication: JWT authentication for HTTP and Socket.io
- fastify-redis: Redis integration for shared state
