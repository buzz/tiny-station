...
- [x] Install Fastify core dependencies
...
- [x] Create Fastify app skeleton in index.ts
...
- [x] Migrate `/api/auth/register` route
...
- [x] Migrate `/api/auth/login` route
   - Create Fastify route with `ZodTypeProvider`
...
- [x] Migrate `/api/auth/verify` route
   - Create Fastify route with `ZodTypeProvider`
...
- [x] Create Fastify JWT authentication middleware
...
- [x] Remove validationMiddleware.ts
...
- [x] Update error handler to Fastify pattern
...
- [x] Remove Express router from authRoutes.ts
...
- [x] Create Fastify plugin for StreamInfoHandler
...
- [x] Update StreamInfoHandler class
...
- [x] Update SocketIOManager JWT authentication
...
- [x] Update SocketIOManager handlers
...
- [x] Run full linting and type checking
